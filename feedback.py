...
async def get_feedback_chain(candidate_name):
    ...
    4. Projects section:
       ...
       d. Comment on each project individually. Use a <br> tag after each project title. For example:</p>
       <p><b>Project Title</b><br>
       Your feedback here...</p>
       If a project is well-presented, offer genuine appreciation. Suggest improvements or expansions where applicable.
